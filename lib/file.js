...
/**
 * Init the file, calculated the hash once up front so that any changes we make
 * to the content does not affect the ability to find similar content.
 *
 * @param {String} content File content.
 * @return {File} fluent interface
 * @api private
 */
File.readable('init', function init(content) {
